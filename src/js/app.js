...
(function () {
  ...
  stepIndex: 0,
      ...
      },
    {
        ...
        description: 'Add cabbage to the pot when potatoes are half way done and boil 7-10min.'
      },
    {
        mediaItems: [
          { src: 'img/9.jpg'}
        ...
        description: 'Next, peel and slice the beets into match sticks.'
      },
    {
        mediaItems: [
          { src: 'img/10.jpg'}
        ...
        description: 'Add 6 cups of water, beets, lemon juice, pepper, bay leaves and can of kidney beans (with their juice). Also add sauted carrots and onion to the pot along with chopped dill. Cook 5-10 minutes, until the cabbage is done.'
      },
    {
        mediaItems: [
          { src: 'img/10.1.jpg'},
      ...
      },
    {
        ...
        header: 'Serving',
        description: 'Please serve the borsch with a dollop of sour cream or real mayo. Wish you bon appetite and enjoy the GREAT TASTE you did yourself! PS: Keep the secret about TastyHub and you will be appreciated as a chef.'
      },
    ]
  });
