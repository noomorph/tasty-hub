...
grunt.initConfig({
  ...
  meta: {
    banner:
      ...
      ' * Original idea by Serg Feldman, Alexander Fedorets, Irina Mamedova'
      ' */'
  },
  ...
  clean: ['dist/js', 'dist/css', 'dist/vendor/'],

  preprocess : {
    index : { src : 'src/index.html', dest : 'dist/index.html' },
    settings : { src : 'src/settings.html', dest : 'dist/settings.html' }
  },
  ...
  copy: {
    main: {
      files: [
        ...
        { src: 'src/vendor/**', dest: 'dist/vendor/' }
      ]
    },
    bower: {
      files: [
        { src: 'src/bower_components/**', src: ['**'], dest: 'dist/bower_components' }
      ]
    }
  },
